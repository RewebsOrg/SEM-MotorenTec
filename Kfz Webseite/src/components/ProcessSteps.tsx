...
const steps = [
    ...
    },
    {
        ...
        description: 'Motorinstandsetzung durch Originalteile für besten Motorlauf',
    },
    {
        number: '04',
    ...
    return (
        <section className="py-16 bg-anthracite relative overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto px-6 relative z-10">
                ...
                >
                    <h2 className="text-accent font-bold tracking-widest text-sm uppercase mb-4">Unser Prozess</h2>
                    <h3 className="text-white text-3xl md:text-5xl font-black tracking-tight mb-4">
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 relative">
                    ...
                    {steps.map((step, index) => (
                        ...
                        >
                            <div className="bg-white/[0.03] border border-white/10 p-8 rounded-2xl h-full transition-all duration-300 ease-out hover:bg-white/[0.06] hover:border-accent/30 hover:-translate-y-1">
                                {/* Step number badge */}
                                <div className="w-14 h-14 bg-accent rounded-xl flex items-center justify-center mb-6 shadow-lg shadow-accent/20 transition-all duration-300 ease-out group-hover:shadow-accent/40 group-hover:scale-105">
                                    <span className="text-white font-black text-lg">{step.number}</span>
                                </div>

                                {/* Icon */}
                                <div className="w-11 h-11 bg-white/5 rounded-lg flex items-center justify-center text-accent mb-5 transition-all duration-300 ease-out group-hover:bg-accent/10">
                                    {step.icon}
                                </div>

                                <h4 className="text-white text-lg font-bold mb-3 transition-colors duration-300 ease-out group-hover:text-accent">
                                    {step.title}
                                </h4>
